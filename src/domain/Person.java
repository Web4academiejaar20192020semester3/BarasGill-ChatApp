...
public class Person {
	...
	private String userId, password, salt, firstName, lastName;
	private Role role;
	...
	public Person(String userId, String password, String firstName,
			String lastName,Role role, String nickName, String status) {
		setUserId(userId);
		setHashedPassword(password);
		setFirstName(firstName);
		setLastName(lastName);
	...
	public Person(String userId, String password, String salt,
			String firstName, String lastName,Role role, String nickName, String status) {
		setUserId(userId);
	...
	public void addFriend(Person person){
		if(person == null){
			throw new DomainException("The given friend does not exist.");
		}
...
/*	@JsonIgnore
	...
	public void addMessage(String message){
		if(message == ""){
			throw new DomainException("The message is invalid.");
		}
